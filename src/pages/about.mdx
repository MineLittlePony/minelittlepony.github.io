---
title: "About"
description: "Special thanks to all the talented artists, coders, and people who have contributed to the mod's development over the years"
heading: "About the Mine Little Pony mod"
---
...
![Splash screen](/assets/about/splash_screen.png)

## Old versions of the mod

If you want to play earlier versions of this mod you can find them <a href={Links.cloudArchive}>here</a>. Please note that they are not supported at all.
...
- Special thanks to **[Keupoz](https://github.com/keupoz)** for updating the site to Jekyll and later to Astro, this was a huge help and a long delayed project that we couldn't have hoped to finish without their help!
...
The skins for the mobs were originally made by Verdana, inspired by the default Minecraft mobs. The zombies used some elements from the mob skins in the [Love&nbsp;and&nbsp;Tolerance](https://www.planetminecraft.com/texture_pack/love-and-tolerance-texture-pack/) texture pack. The skeletons were made by **dann494**.
...
- Thanks to **oskarek11** who drew the image of Princess Celestia from which the hair was borrowed in [the header image](https://mega.nz/#!YBZT0KCa!ubCikvjkLVgziA58yMehTrhZPBRje45M8jsXVYPF1Vw)
- Kudos to the original pony mod (Verdana didn't use any of the code but someone else had the idea first) posted on ponycraft.net (now removed, [archive](https://web.archive.org/web/20130124171230/http://ponycraft.net:80/))
- Thanks to everyone in [MinecraftForum.net thread](https://www.minecraftforum.net/forums/mapping-and-modding-java-edition/minecraft-mods/1278090-mine-little-pony-v1-6-4-1) and on brohoof.com ([archive](https://web.archive.org/web/20150502042354/http://www.brohoof.com:80/)) for your feedback, testing and support so far
- This mod uses [Fabric](https://fabricmc.net/)
- Pre 1.13 versions of this mod use Mumfrey's [LiteLoader](https://www.liteloader.com). Need a tick and don't want much else? LiteLoader might be the lightweight mod loader you've been waiting for!
