...
import MembersList from "@/components/about/MembersList.astro";

> Original Verdana's thanks can be found [here](/legacy/thanks/)
...
![Splash screen](/about/splash_screen.png)
...
- Special thanks to **[Keupoz](https://github.com/keupoz)** for updating the site to Jekyll, this was a huge help and a long delayed project that we couldn't have hoped to finish without their help!
