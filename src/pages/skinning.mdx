...
import PixelsList from "@/components/skinning/PixelsList.astro";
...
![Complex skin layout](/skinning/complextemplate.png "Complex skin layout")
...
![Twilight Sparkle complex skin layout](/skinning/twilight_complex_template.png "Twilight Sparkle complex skin layout")

[Download Twilight Sparkle complex skin](/skinning/twilight_complex.png)
...
![Simple skin template](/skinning/simpletemplate.png)
...
![Twilight Sparkle simple skin layout](/skinning/twilight_simple_template.png)
![Steve simple skin layout](/skinning/steve_simple_template.png)

[Download Twilight Sparkle simple skin](/skinning/twilight_simple.png)
...
> ![Flipped textures of the body](/skinning/flippedtextures.png)
...
![Twilight Sparkle SD complex skin layout](/skinning/twilight_complex_template.png)
![HD complex skin layout](/skinning/hdskin.png)
...
![Bat Pony (EEEE)](/skinning/stardust_accessories_upscaled.png)
![Sea Pony (20,000 EEEEs Under the Sea!)](/skinning/seapony_upscaled.png)
![Changeling (they're not a bug ok?)](/skinning/changeling_upscaled.png)
![Zebra (fun fact, zebras are actually black with white stripes! How neat is that?!)](/skinning/zebra_upscaled.png)

[Download the four example skins:](/skinning/example_skins.zip)
...
![Stardust wearing his snazzy hat stack, just like something straight out of TF2!](/skinning/hatstack.png)

Now let's see how this is actually accomplished!

![The Skin (with it's pixels of course!)](/skinning/stardust_accessories_upscaled.png)
![HD complex skin layout](/skinning/accessory_values.png)

[Download the Stardust Accessory Example Skin!](/skinning/stardust_complex_accessories.png)
...
![Uploading skin to Minecraft.net](/skinning/minecraftupload.png)
...
![Uploading skin to the mod's server](/skinning/minelpupload.png)
![Drop window](/skinning/drop.png)
