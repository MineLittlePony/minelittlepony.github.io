...
There are not enough frequently asked questions. But feel free to ask them on the <a href={Links.discordInvite}>Discord server</a>.
...
You can do it on GitHub [here](https://github.com/MineLittlePony/MineLittlePony/issues) or in the channel `#bugs` of our <a href={Links.discordInvite}>Discord server</a>.
